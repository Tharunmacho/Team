...
class TransgenderVoterInfoScreen extends StatefulWidget {
  final TransgenderVoter voter;
  
  const TransgenderVoterInfoScreen({super.key, required this.voter});

  @override
  State<TransgenderVoterInfoScreen> createState() => _TransgenderVoterInfoScreenState();
}

class _TransgenderVoterInfoScreenState extends State<TransgenderVoterInfoScreen> with TickerProviderStateMixin {
